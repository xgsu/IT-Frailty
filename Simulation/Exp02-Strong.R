...
SIZE
save(BOOTS, BTREE, SIZE, file="result2-Strong-exp.Rdat") 
...
SIZE
save(BOOTS, BTREE, SIZE, file="result2-Strong-Weibull.Rdat") 
...
FILES <- c("result2-Strong-exp.Rdat", "result2-Strong-Weibull.Rdat")
