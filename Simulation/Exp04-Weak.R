...
SIZE
save(BOOTS, BTREE, SIZE, file="result4-Weak-exp.Rdat") 
...
SIZE
save(BOOTS, BTREE, SIZE, file="result4-Weak-Weibull.Rdat") 
...
FILES <- c("result4-Weak-exp.Rdat", "result4-Weak-Weibull.Rdat")
