...
SIZE
save(BOOTS, BTREE, SIZE, file="result3-GammaFrailty-Null-exp.Rdat") 
...
SIZE
save(BOOTS, BTREE, SIZE, file="result3-GammaFrailty-Null-Weibull.Rdat") 
...
FILES <- c("result3-GammaFrailty-Null-exp.Rdat", "result3-GammaFrailty-Null-Weibull.Rdat")
